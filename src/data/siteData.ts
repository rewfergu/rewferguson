...
export const siteData: siteDataType[] = [
  ...
  },
  {
    ...
    cover: {
      ...
      alt: 'The ACC Online home page screenshot with main menu and header image depicting students gathering around a computer',
    },
    description:
      'ACC did not have a html based catalog, just a pdf. We put together a CMS based in WordPress so that content owners could update pages, fed that content into react components through the REST API, and we rendered and archived static versions with Gatsby',
  ...
  },
  {
    ...
    status: 3,
    cover: {
      src: 'projects/Branches/output.png',
      alt: 'randomly generated artwork created in Processing',
    },
    description:
  ...
  },
  {
    ...
    status: 2,
    cover: {
      src: 'projects/Budget-Tracker/sample.png',
      alt: 'screenshot of the budget tracker app',
    },
    description:
  ...
  },
  {
    ...
    status: 3,
    cover: {
      src: 'projects/DynamiCat/threeCats.png',
      alt: 'three cat faces created in Processing',
    },
    description:
  ...
  },
  {
    ...
    status: 3,
    cover: {
      src: 'projects/Frame-Squeezer/output.png',
      alt: 'movie barcode image created in Processing',
    },
    description:
  ...
  },
  {
    ...
    status: 2,
    cover: {
      src: 'projects/hangman/hangman.png',
      alt: 'screenshot of the hangman game',
    },
    description:
  ...
  },
  {
    ...
    cover: {
      ...
      alt: 'The Public Safety Training Center home page screenshot with main menu and hero image showing students in training',
    },
    description:
    ...
    images: [
      {
        ...
        alt: 'full screenshot of the home screen for the Public Safety Training Center website',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    cover: {
      ...
      alt: 'Notecode screenshot showing the syntax highlighting for a snippet of js code',
    },
  ...
  },
  {
    ...
    status: 3,
    cover: {
      src: 'projects/Photo-Scramble/header.png',
      alt: 'screenshot of the photo scramble game',
    },
    description:
  ...
  },
  {
    ...
    status: 2,
    cover: {
      src: 'projects/Quadcopter/header.svg',
      alt: 'quadcopter schematic',
    },
    description:
  ...
  },
  {
    ...
    status: 3,
    cover: {
      src: 'projects/Udacity-Arcade-Game-projects/screenshot.png',
      alt: 'screenshot of the Udacity Arcade Game Project',
    },
    description:
  ...
  },
  {
    ...
    status: 3,
    cover: {
      src: 'projects/Udacity-Neighborhood-Map-projects/header.png',
      alt: 'screenshot of the Udacity Neighborhood Map Project',
    },
    description:
  ...
  },
  {
    ...
    status: 2,
    cover: {
      src: 'projects/Untitled-Water-Drop-Game/header.gif',
      alt: 'animated gif of the water drop game',
    },
    description:
  ...
  },
  {
    ...
    cover: {
      ...
      alt: 'an svg illustration of the weather lamp',
    },
    description:
