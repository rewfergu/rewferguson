...
const siteData = [
  {
    ...
    status: 2,
    featured: true,
    cover: 'projects/ACC-Catalog/cover.jpg',
    description: 'ACC did not have a html based catalog, just a pdf. We put together a CMS based in WordPress so that content owners could update pages, fed that content into react components through the REST API, and we rendered and archived static versions with Gatsby',
    tags: ['react', 'Gatsby', 'WordPress', 'aws', 'cloudfront', 's3'],
    link: 'https://catalog.austincc.edu',
    images: [
      'projects/ACC-Catalog/catalog.austincc.edu.png',
      'projects/ACC-Catalog/catalog.austincc.edu2.png',
  ...
  },
  {
    ...
    status: 2,
    featured: true,
    cover: 'projects/ACC-Online/cover.jpg',
    description: 'ACC did not have a html based catalog, just a pdf. We put together a CMS based in WordPress so that content owners could update pages, fed that content into react components through the REST API, and we rendered and archived static versions with Gatsby',
    tags: ['react', 'Gatsby', 'WordPress'],
    link: 'https://catalog.austincc.edu',
    images: ['projects/ACC-Online/online.austincc.edu.png']
  },
  {
  ...
  },
  {
    ...
    slug: 'franktank',
    status: 1,
    description: 'YouTube player application that curates sports videos and allows users to comment on and favorite time based segments.',
  ...
  },
  {
    ...
    description: 'An online version of the hangman game with user authentication, single player and real time multiplayer capabilities.',
  ...
  },
  {
    ...
    status: 1,
    featured: true,
    cover: 'projects/Notecode/notecode.png',
    ...
    images: [
      'projects/Notecode/notecode-c3469.firebaseapp.com_.png',
      'projects/Notecode/notecode-c3469.firebaseapp.com_2.png'
    ]
  },
  {
    name: 'Octopus',
  ...
  // },
  {
    ...
    link: '',
    images: [
      'projects/photo-search/img_2173.png',
      'projects/photo-search/img_2174.png',
      'projects/photo-search/img_2175.png'
    ],
  ...
  },
  {
    ...
    status: 1,
    featured: true,
    cover: 'projects/sounddeck/screenshot.png',
    description: 'A community dj app based on the soundcloud api allowing users to enter rooms, curate playlists, and vote on the best tracks.',
    tags: [
      'react',
      'socket.io',
      'express',
  ...
  },
  {
    ...
    status: 3,
    featured: true,
    cover: 'projects/Timer/header.svg',
    ...
    images: [
      'projects/Timer/screenshot.png',
      'projects/Timer/ryj173yr0p.codesandbox.io_.png'
    ]
  },
  {
    name: 'TodoRedo',
    ...
    status: 1,
    featured: true,
    cover: 'projects/TodoRedo/todoredo2.png',
    description: 'A simple todo list built in React and Firebase. I’ve never made one, so I wanted to try one as a test. The only aspect of this app that I haven’t seen anywhere else is I wanted a daily list that would reset itself each day. I have items that I would like to check off each day, and the next morning be presented with a fresh list.',
    tags: ['react', 'firebase', 'javascript'],
    github: 'https://github.com/rewfergu/todoredo',
    link: 'https://todoredo.firebaseapp.com',
    images: [
      'projects/TodoRedo/todoredo.firebaseapp.com_.png',
      'projects/TodoRedo/todoredo.firebaseapp.com_1.png',
      'projects/TodoRedo/todoredo.firebaseapp.com_2.png'
    ]
  },
  {
